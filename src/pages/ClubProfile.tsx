...
import {
  ...
  MessageSquare, Image, ChevronLeft, Crown, Mail, Phone
} from "lucide-react";
      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="pt-24 pb-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <Link to="/clubes">
              <Button variant="hero">Ver Clubes</Button>
            </Link>
          </div>
        </main>
        <Footer />
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="glass-card rounded-2xl p-6">
                ...
                <p className="text-muted-foreground leading-relaxed whitespace-pre-wrap">
                  {maskSensitiveInfo(club.description || "Nenhuma descrição disponível.", isPremium)}
                </p>
              </div>
                ...
                {isPremium ? (
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-muted-foreground mb-4">
                      Dados de contato oficiais estão visíveis apenas para assinantes.
                    </p>
