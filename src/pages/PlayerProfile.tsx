...
import {
  ...
  MessageSquare, Play, ExternalLink, ChevronLeft, Award, Mail, Phone, Users
} from "lucide-react";
      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="pt-24 pb-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <Link to="/jogadores">
              <Button variant="hero">Ver Jogadores</Button>
            </Link>
          </div>
        </main>
        <Footer />
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="glass-card rounded-2xl p-6">
                ...
                <p className="text-muted-foreground leading-relaxed whitespace-pre-wrap">
                  {maskSensitiveInfo(player.description || "Nenhuma descrição disponível.", isPremium)}
                </p>
              </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3 text-sm">
                    ...
                    <span className="text-muted-foreground">
                      {player.city}, {player.state}, {player.nationality}
                    </span>
                  </div>
                  {age && (
                    <div className="flex items-center gap-3 text-sm">
