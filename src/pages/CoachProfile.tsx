...
import {
    ...
    MessageSquare, Play, ExternalLink, ChevronLeft, Award, GraduationCap, Mail, Phone
} from "lucide-react";
...
const CoachProfile = () => {
    ...
    const { currentUser, isPremium, isAdmin } = useUser();
            ...
            <div className="min-h-screen bg-background">
                ...
                <main className="pt-24 pb-16">
                    <div className="container mx-auto px-4 text-center">
                        ...
                        <Link to="/tecnicos">
                            <Button variant="hero">Ver Técnicos</Button>
                        </Link>
                    </div>
                </main>
                <Footer />
                        ...
                        <div className="lg:col-span-2 space-y-6">
                                ...
                                <div className="pt-20 pb-6 px-8">
                                    <div className="flex flex-wrap items-start justify-between gap-4">
                                        <div>
                                            ...
                                            <span className={`inline-block px-3 py-1 rounded-md text-sm font-medium mt-2 ${getStatusColor(coach.status)}`}>
                                                {coach.status}
                                            </span>
                                        </div>
                            ...
                            <div className="glass-card rounded-2xl p-6">
                                ...
                                <p className="text-muted-foreground leading-relaxed whitespace-pre-wrap">
                                    {maskSensitiveInfo(coach.description || "Nenhuma descrição disponível.", isPremium)}
                                </p>
                            </div>
                            ...
                            <div className="glass-card rounded-2xl p-6">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {coach.certifications.length > 0 ? coach.certifications.map((cert, index) => (
                                        <span key={index} className="px-3 py-1.5 rounded-lg bg-secondary text-sm font-medium border border-border">
                                            {cert}
                                        </span>
                                    )) : (
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3 text-sm">
                                        ...
                                        <span className="text-muted-foreground">
                                            {coach.city}, {coach.state}, {coach.nationality}
                                        </span>
                                    </div>
                                    {age && (
                                        <div className="flex items-center gap-3 text-sm">
                                ...
                                {isPremium ? (
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-xs text-muted-foreground mb-4">
                                            Dados de e-mail e telefone estão visíveis apenas para assinantes.
                                        </p>
