...
import {
  ...
  MessageSquare, ChevronLeft, Building, Crown, Mail, Phone
} from "lucide-react";
      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="pt-24 pb-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <Link to="/agentes">
              <Button variant="hero">Ver Agentes</Button>
            </Link>
          </div>
        </main>
        <Footer />
            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                <div className="pt-20 pb-6 px-8">
                  <div className="flex flex-wrap items-start justify-between gap-4">
                    <div>
                      ...
                      {agent.agency && (
                        <p className="text-primary text-lg font-medium">{agent.agency}</p>
                      )}
                    </div>
              ...
              <div className="glass-card rounded-2xl p-6">
                ...
                <p className="text-muted-foreground leading-relaxed whitespace-pre-wrap">
                  {maskSensitiveInfo(agent.description || "Nenhuma descrição disponível.", isPremium)}
                </p>
              </div>
                ...
                {isPremium ? (
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-muted-foreground mb-4">
                      Dados de contato profissional estão visíveis apenas para assinantes.
                    </p>
